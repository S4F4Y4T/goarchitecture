...
func NewUserRepository(db *gorm.DB) model.Repository {
	return &UserRepository{db: db}
}

func (r *UserRepository) GetAll(ctx context.Context, p pagination.Params, opts query.Options) ([]model.User, int64, error) {
	var (
		users []model.User
		total int64
	)
...
func (r *UserRepository) Update(ctx context.Context, id int, user *model.User) (*model.User, error) {
...
func (r *UserRepository) WithTx(ctx context.Context, fn func(model.Repository) error) error {
